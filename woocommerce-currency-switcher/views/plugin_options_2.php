...
<div class="subsubsub_section woocs_subsubsub_section">
	...
	<div class="section">
		...
		<div class="woocs__section-title woocs-mb-4">
			...
			<i>
			<?php
			// translators: %s is plugin version
			printf( esc_html__( 'Maintained for WooCommerce v.%s.x', 'woocommerce-currency-switcher' ), esc_html( $this->actualized_for ) )
			?>
			</i>
		...
		<div id="tabs" class="woocs__tabs">
			<?php if ( version_compare( WOOCOMMERCE_VERSION, WOOCS_MIN_WOOCOMMERCE, '<' ) ) : ?>
				...
				<?php
				// translators: %s is a variable value.
				printf( esc_html__( 'Your version of WooCommerce plugin is too obsolete. Update minimum to %s version to avoid malfunctionality!', 'woocommerce-currency-switcher' ), esc_html( WOOCS_MIN_WOOCOMMERCE ) )
				?>
				</b>
			<?php endif; ?>
						...
						<table class="woocs__table">
							...
							<tbody>
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php woocs_draw_select_e( $welcome_curr_options, get_option( 'woocs_welcome_currency', '' ), 'woocs_welcome_currency' ); ?>
										</div>
									</td>
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php woocs_draw_select_e( $aggregators, get_option( 'woocs_currencies_aggregator', '' ), 'woocs_currencies_aggregator' ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php woocs_draw_select_e( $storage_options, get_option( 'woocs_storage', '' ), 'woocs_storage', 'woocs_storage' ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											...
											woocs_draw_select_e(
												...
												get_option( 'woocs_currencies_rate_auto_update', '' ),
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_show_flags', get_option( 'woocs_show_flags', 1 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_special_ajax_mode', get_option( 'woocs_special_ajax_mode', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_show_money_signs', get_option( 'woocs_show_money_signs', 1 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_price_info', get_option( 'woocs_price_info', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_rate_auto_update_email', get_option( 'woocs_rate_auto_update_email', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_restrike_on_checkout_page', get_option( 'woocs_restrike_on_checkout_page', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_show_approximate_amount', get_option( 'woocs_show_approximate_amount', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_show_approximate_price', get_option( 'woocs_show_approximate_price', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_shop_is_cached', get_option( 'woocs_shop_is_cached', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr <?php echo ( ! get_option( 'woocs_shop_is_cached', 0 ) ) ? "style='display:none'" : ''; ?>>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_shop_is_cached_preloader', get_option( 'woocs_shop_is_cached_preloader', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_show_top_button', get_option( 'woocs_show_top_button', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
						...
						<table class="woocs__table">
							...
							<tbody>
										...
										<div class="woocs__table-card woocs__table-card-with-el">
											<div class="woocs-d-flex woocs-align-items-center woocs-flex-with-margin">
												<div class="woocs__item">
													...
													echo wp_kses( woocs_draw_switcher23( 'woocs_is_fixed_enabled', $woocs_is_fixed_enabled, 'woocs_blind_option' ), woocs_get_allowed_html_switcher23() );
													?>
												</div>
												<div class="woocs__item">
								...
								if ( ! $woocs_is_fixed_enabled ) :
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_force_pay_bygeoip_rules', get_option( 'woocs_force_pay_bygeoip_rules', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								if ( ! $woocs_is_multiple_allowed ) :
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_is_fixed_coupon', get_option( 'woocs_is_fixed_coupon', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								if ( ! $woocs_is_multiple_allowed ) :
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_is_fixed_shipping', get_option( 'woocs_is_fixed_shipping', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_is_fixed_user_role', get_option( 'woocs_is_fixed_user_role', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td>
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card woocs__table-card-with-el">
											<div class="woocs-d-flex woocs-align-items-center woocs-flex-with-margin">
												<div class="woocs__item">
													<?php echo wp_kses( woocs_draw_switcher23( 'woocs_is_geoip_manipulation', get_option( 'woocs_is_geoip_manipulation', 0 ), 'woocs_blind_option' ), woocs_get_allowed_html_switcher23() ); ?>
												</div>
												<div class="woocs__item">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_payments_rule_enabled', get_option( 'woocs_payments_rule_enabled', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_disable_reset_currency_bots', get_option( 'woocs_disable_reset_currency_bots', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											<?php echo wp_kses( woocs_draw_switcher23( 'woocs_schema_in_current_currency', get_option( 'woocs_schema_in_current_currency', 0 ) ), woocs_get_allowed_html_switcher23() ); ?>
										</div>
									</td>
									<td data-title="<?php echo esc_html__( 'Description', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-desc">
								...
								<tr>
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card woocs__table-card-with-el">
											...
											echo wp_kses( woocs_draw_switcher23( 'woocs_is_auto_switcher', $woocs_is_auto_switcher, 'woocs_is_auto_switcher' ), woocs_get_allowed_html_switcher23() );
											?>
											<br>
												<a id="woocs-modal-link" href="<?php echo esc_attr( WOOCS_LINK ); ?>img/side-switcher.png" class="woocs__link woocs__link-img 
												<?php
									...
									<td data-title="<?php echo esc_html__( 'Status', 'woocommerce-currency-switcher' ); ?>">
										<div class="woocs__table-card">
											...
											<div class="woocs__table-card-flex ">
												...
												<div class="woocs_roll_blocks_width" class="
												<?php
												if ( $woocs_auto_switcher_skin != 'roll_blocks' ) :
													?>
													woocs_settings_hide<?php endif; ?>">
													...
													<tr>
														<td class="woocs__settings-geo-table-title">
															...
															if ( $currency['is_etalon'] ) :
																?>
																woocs_hint<?php endif; ?>"><strong><?php echo esc_html( $key ); ?>:</strong></div>
														</td>
																		...
																		<div class="woocs__stat-col" style="flex-basis: 25%;">
																			<ul class="woocs__list">
																				...
																				<li>
																					...
																					<input type="hidden" id="woocs-stat-calendar-min-y" value="<?php echo esc_html( gmdate( 'Y', $min_date ) ); ?>" />
																					<input type="hidden" id="woocs-stat-calendar-min-m" value="<?php echo ( intval( gmdate( 'm', $min_date ) ) - 1 ); ?>" />
																					<input type="hidden" id="woocs-stat-calendar-min-d" value="<?php echo esc_html( gmdate( 'd', $min_date ) ); ?>" />
													...
													function woocs_print_currency( $_this, $currency ) {
														...
														<tr data-etalon="<?php echo esc_attr( $is_etalon ); ?>">
															...
															<td data-title="<?php esc_html_e( 'Decimal', 'woocommerce-currency-switcher' ); ?>">
																...
																<select name="woocs_decimals[]" class="woocs-drop-down woocs-decimals" title="<?php echo esc_html__( 'Decimals', 'woocommerce-currency-switcher' ); ?>">
																	...
																	<?php foreach ( $woocs_decimals as $v => $n ) : ?>
																		<option 
																		<?php
																		if ( $currency['decimals'] == $v ) :
																			?>
																			selected=""<?php endif; ?> value="<?php echo esc_attr( $v ); ?>"><?php echo esc_html( $n ); ?></option>
																	<?php endforeach; ?>
																</select>
															...
															<td data-title="<?php esc_html_e( 'Separators', 'woocommerce-currency-switcher' ); ?>">
																...
																<select name="woocs_separators[]" class="woocs-drop-down" title="<?php echo esc_html__( 'Separators', 'woocommerce-currency-switcher' ); ?>">
																	...
																	foreach ( $separators as $k => $v ) :
																		...
																		<option 
																		<?php
																		if ( isset( $currency['separators'] ) and $currency['separators'] == $k ) :
																			?>
																			selected=""<?php endif; ?> value="<?php echo esc_attr( $k ); ?>"><?php echo esc_html( $v ); ?></option>
																	<?php endforeach; ?>
																</select>
															...
															<td data-title="<?php esc_html_e( 'Visible', 'woocommerce-currency-switcher' ); ?>">
																<?php echo wp_kses( woocs_draw_switcher23( 'woocs_hide_on_front[]', boolval( isset( $currency['hide_on_front'] ) ? $currency['hide_on_front'] : 0 ), '', '', true ), woocs_get_allowed_html_switcher23() ); ?>
															</td>


															<td data-title="<?php esc_html_e( 'Cents', 'woocommerce-currency-switcher' ); ?>">
																<select name="woocs_hide_cents[]" class="woocs-mw105 woocs-drop-down" 
																<?php
