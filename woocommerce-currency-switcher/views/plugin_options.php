                    ...
                    <div class="wcf-control-section">
                        ...
                        <div id="woocs_tools_panel">
                            ...
                            <div class="woocs_drop_down_view_panel">
                                ...
                                <label for="woocs_drop_down_view" class="woocs-options-valign-top"><span class="woocommerce-help-tip" data-tip="<?php echo __('How to display currency switcher (by default) on the site front. (NEW) Make your attention on skins with numbers - you can use them on the same page with different designs in shortcode [woocs] described in its attribute style and style number (see Codex page in Info Help tab)!', 'woocommerce-currency-switcher') ?>"></span></label>
                    ...
                    <div class="wfc-control-section-xxx">
                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr valign="top">
                                    <th scope="row" class="titledesc">
                                        <label for="woocs_show_top_button"><?php echo __('Show options button on top admin bar.', 'woocommerce-currency-switcher') ?></label>
                            ...
                            <tr>
                                ...
                                <td class="woocs-options-fix6">
                                    ...
                                    <ul class="woocs-ml-15">
                                        ...
                                        <li><a href="javascript: woocs_stat_redraw(1); void(0);" id="woocs_stat_redraw_1" class="woocs_stat_redraw_btn woocs-panel-button dashicons-before dashicons-update"><?php echo $this->statistic->get_label(1) ?></a>&nbsp;<label class="woocs-options-valign-top"><span class="woocommerce-help-tip" data-tip="<?php echo __('For currencies - aggregated data about selected currencies on the site front. For orders - count of orders made in the selected currencies.', 'woocommerce-currency-switcher') ?>"></span></label></li>
                                        <li><a href="javascript: woocs_stat_redraw(2); void(0);" id="woocs_stat_redraw_2" class="woocs_stat_redraw_btn woocs-panel-button dashicons-before dashicons-update"><?php echo $this->statistic->get_label(2) ?></a>&nbsp;<label class="woocs-options-valign-top"><span class="woocommerce-help-tip" data-tip="<?php echo __('For currencies - aggregated data about count of countries which users selected currencies on the site front. For orders - count of orders made from countries, detected by selected country in the billing address.', 'woocommerce-currency-switcher') ?>"></span></label></li>
                                    </ul>
                                </td>
                            </tr>
                        </table>
                ...
                <section id="tab-smart-designer">
                                    ...
                                    <?php if (!empty($designs)): ?>
                                        <?php foreach ($designs as $design_id) : ?>
                                            <tr id="woocs-sd-dashboard-tr-<?php echo $design_id ?>">
                                                ...
                                                <td>
                                                    sd-<?php echo $design_id ?>
                                                </td>
                                                <td>
                                                    [woocs sd=<?php echo $design_id ?>]
                                                </td>
                                                <td>
                    ...
                    <template id="woocs-sd-work-area-tpl">
                        <div class="woocs-sd-main-wrapper">
                            ...
                            <div id="woocs-sd-dd" class="woocs-sd-panel woocs-sd-panel-current" data-menu='<?php echo json_encode($menu) ?>'>
                                ...
                                <div id="selectron23-example-container">
                                    ...
                                    ?>
                                    <div id="selectron23-example" data-woocs-sd-currencies='<?php echo json_encode($currencies) ?>'></div>
                        ...
                        <div id="woocs-sd-main-buttons">
                            <div><a href="javascript: woocs_sd_save();void(0);" class="woocs-panel-button dashicons-before dashicons-cloud-saved"><?php esc_html_e("Save", 'woocommerce-currency-switcher') ?></a>&nbsp;</div>
...
function woocs_print_currency($_this, $currency) {
    ...
    <tr>
        ...
        <td>
            <select class="woocs-drop-down woocs-position woocs-mw130" name="woocs_position[]" title="<?php echo __('Select symbol position', 'woocommerce-currency-switcher') ?>">
                <?php
        ...
        <td>
            ...
            ?>
            <select name="woocs_hide_on_front[]" class="woocs-mw75 <?php if ($hide_on_front): ?>woocs-red<?php endif; ?> woocs-drop-down woocs_hide_on_front_select" title="<?php echo __('Show currency for all on the site front or Hide for private moments in wp admin panel using only.', 'woocommerce-currency-switcher') ?>">
