...
class WOOCS_ADV {
	...
	public function __construct( $alert_list = array() ) {
		...
		if ( isset( $_SERVER['REQUEST_URI'] ) ) {
			...
			if ( substr_count( $_SERVER['PHP_SELF'], 'theme-install.php' ) ) {// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized,WordPress.Security.ValidatedSanitizedInput.MissingUnslash
				return;
			}
		}
